const Discord = require('discord.js');GG WP
...
client.on('message', msg => {
  if (msg.content === prefix + "komutlar") {
   ...
   .addField(`${prefix}aboneol`, `Hakkı Çanak Youtube kanalının linkini atar.`)
...
client.on('message', msg => {
  ...
  if (msg.content.toLocaleLowerCase() === prefix + "platdesteaç") {
    msg.reply(`Platin deste açmak isteğinize emin misiniz?**${prefix}!evet/${prefix}!hayır**`)
  }
  ...
  if (msg.content.toLocaleLowerCase() === prefix + "sonyayın") {
      msg.channel.sendMessage('https://www.youtube.com/watch?v=1a1vBHFVGYs')
  }
  if (msg.content.toLocaleLowerCase() === prefix + "aboneol") {
    msg.channel.sendMessage('https://www.youtube.com/channel/UCxcRLfaS-4pGaEfEbDptSWQ')
  }
  if (msg.content === prefix + "rastgeleyayın") {
    ...
    var mesaj1 = "https://www.youtube.com/watch?v=3jsyGuzfjqY"
    var mesaj2 = "https://www.youtube.com/watch?v=3jsyGuzfjqY"
    var mesaj3 = "https://www.youtube.com/watch?v=Cmmxq4kfOaQ"
    var mesaj4 = "https://www.youtube.com/watch?v=7StGBtllVX4"
    var mesaj5 = "https://www.youtube.com/watch?v=S-ZLEfQhVP0"
    var mesaj6 = "https://www.youtube.com/watch?v=8IYlVsjGDbk"
    var mesaj7 = "https://www.youtube.com/watch?v=qGaOKQ58vDE"
...
if (msg.content.toLocaleLowerCase() === prefix + "evet") {
 ...
 if (msg.content.toLowerCase() === prefix + "yayın") {
   msg.reply('https://www.youtube.com/watch?v=NGGO64j9HRk')
 }
});
...
client.login('NDUyOTg2MzM0NTEzMjAxMTUz.DfYT8Q.rRUlqRTuOpXavCZQh_n3Xs4az6s');
